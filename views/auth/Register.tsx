          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 lg:px-32">
            ...
            <div className="w-1/2 flex items-center justify-center mx-auto mt-4">
              <button
                ...
                className={`hover:shadow-form rounded-full bg-primary py-3 px-8 text-base md:text-lg lg:text-[25px] font-semibold text-white outline-none w-full ${isSubmitting || isSubmittingLocal ? 'opacity-70 cursor-not-allowed' : ''
                  }`}
              >
