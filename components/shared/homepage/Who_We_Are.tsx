      ...
      <div className="flex flex-col lg:flex-row relative w-full mx-auto">
        ...
        <div className="w-full lg:w-1/2 lg:ps-[12%] py-12 px-4 lg:px-0">
          ...
          <div className="mb-16 lg:mb-24">
            <Copy>
              <h2
                className={`font-sans font-semibold text-[#1E1E1E] text-[32px] lg:text-[72px] mb-4 lg:mb-0`}
              >
                Who we are
              </h2>
            </Copy>
            ...
            <div className="mb-6 w-full lg:max-w-md lg:ps-[2%]">
              <Copy>
                <p className="text-gray-700 text-base md:text-lg lg:text-[25px] leading-[32px] mb-2 font-normal font-sans w-full">
            ...
            <div className="mb-8 w-full lg:max-w-md lg:ps-[2%]">
              <Copy delay={0.2}>
                <p className="text-gray-700 text-base md:text-lg lg:text-[25px] leading-[32px] font-normal font-sans w-full">
          ...
          <div className="mb-16">
            <Copy delay={0.3}>
              <h2
                className={`font-sans font-semibold text-[#1E1E1E] text-[28px] md:text-[32px] lg:text-[72px] mb-4 lg:mb-0`}
              >
                What we do
              </h2>
            </Copy>
            ...
            <div className=" mb-6 w-full lg:max-w-md lg:ps-[2%]">
              <Copy delay={0.4}>
                <p className="text-gray-700 text-base md:text-lg lg:text-[25px] leading-[32px] font-normal font-sans">
